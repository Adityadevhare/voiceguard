...
export type StorageHash =
  StorageHashBase<'e8b4f23f4cb653d4a03c3aa0641e03332060fb4ed4f03d1fb10d10d4f6e3f4da'>;
...
export type FieldOutputTypes = {
  readonly public: {
    readonly Detection: {
      ...
      readonly processingTime: CodecTypes['pg/int4@1']['output'] | null;
...
export type FieldInputTypes = {
  readonly public: {
    readonly Detection: {
      ...
      readonly processingTime: CodecTypes['pg/int4@1']['input'] | null;
        ...
        readonly entries: {
          readonly table: {
            readonly detection: {
              ...
              indexes: readonly [
                {
                  readonly name: 'detection_userId_idx_a489d58a';
                  readonly prefix: 'detection_userId_idx';
...
> & {
  ...
  readonly roots: {
    ...
    readonly detection: { readonly namespace: 'public' & NamespaceId; readonly model: 'Detection' };
  };
  readonly domain: {
    readonly namespaces: {
      readonly public: {
          ...
          readonly Detection: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly processingTime: { readonly column: 'processingTime' };
